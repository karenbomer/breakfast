 ...
 */
final class Version20220404142825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bakery ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE bakery ADD CONSTRAINT FK_C647FA2AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_C647FA2AA76ED395 ON bakery (user_id)');
        $this->addSql('ALTER TABLE `order` ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_F5299398A76ED395 ON `order` (user_id)');
        $this->addSql('ALTER TABLE product ADD bakery_id INT NOT NULL, ADD category_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_D34A04AD5570DBC4 ON product (bakery_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C647FA2AA76ED395 ON bakery');
        ...
        $this->addSql('DROP INDEX IDX_D34A04AD5570DBC4 ON product');
        $this->addSql('DROP INDEX IDX_D34A04AD12469DE2 ON product');
        $this->addSql('ALTER TABLE product DROP bakery_id, DROP category_id');
    }
}
